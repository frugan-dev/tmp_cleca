...
echo !empty($this->Mod->menu_ids) ? implode(', ', array_map('__', array_filter($this->config['mod.'.$this->controller.'.menu.arr'], fn ($key) => in_array($key, $this->Mod->menu_ids, true), ARRAY_FILTER_USE_KEY))) : '&nbsp;';
