...
if (isset($this->Mod->postData['type']) && $this->Mod->postData['type'] === basename(__DIR__) && isset($this->Mod->postData[$key]['value'])) {
    $params['value'] = $this->Mod->postData[$key]['value'];
    $params['attr']['value'] = $this->Mod->postData[$key]['value'];
} elseif ($this->Mod->type === basename(__DIR__)) {
    $params['value'] = $this->Mod->{$key}['value'] ?? '';
    $params['attr']['value'] = $this->Mod->{$key}['value'] ?? '';
}
