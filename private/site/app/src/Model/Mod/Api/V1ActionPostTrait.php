...
trait V1ActionPostTrait
{
    protected function v1ActionPost(RequestInterface $request, ResponseInterface $response, $args)
    {
    ...
    protected function v1ActionPostAdd(RequestInterface $request, ResponseInterface $response, $args)
    {
    ...
    protected function _v1ActionPostAdd(RequestInterface $request, ResponseInterface $response, $args): void
    {
        ...
        if (0 === \count($this->errors)) {
            ...
            if (0 === \count($this->errors)) {
                $this->responseData['response'] = $insertId;
            }
        }
    }
}
