...
$params['optgroup'][1] = __('Fields');

foreach ($this->Mod->getFieldTypes('form') as $k => $v) {
    $params['options'][] = [
        'value' => $v,
        'optgroup_id' => 1,
        'attr' => [
...
$params['optgroup'][2] = __('Blocks');

foreach ($this->Mod->getFieldTypes('block') as $k => $v) {
    $params['options'][] = [
        'value' => $v,
        'optgroup_id' => 2,
        'attr' => [
...
$params['optgroup'][3] = __('Special');

foreach ($this->Mod->getFieldTypes('special') as $k => $v) {
    $params['options'][] = [
        'value' => $v,
        'optgroup_id' => 3,
        'attr' => [
