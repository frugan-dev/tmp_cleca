...
if (file_exists(_ROOT.'/vendor/umpirsky/country-list/data/'.$this->lang->locale.'/country.php')) {
    $languages = require _ROOT.'/vendor/umpirsky/country-list/data/'.$this->lang->locale.'/country.php';

    foreach ($languages as $itemKey => $itemVal) {
        $params['options'][$itemKey] = $itemKey.' - '.$itemVal;
    }
}
