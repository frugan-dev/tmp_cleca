...
echo '' !== trim((string) $this->Mod->multilang[$langId][$key]['value']) ? '<a title=""'.$this->escapeAttr([
    'href' => 'tel:'.$this->helper->Strings()->phoneUri($this->Mod->multilang[$langId][$key]['value']),
]).'>'.$this->escape()->html($this->Mod->multilang[$langId][$key]['value']).'</a>' : '&nbsp;';
